let User,jwt;_6e3‍.x([["signUp",()=>signUp],["login",()=>login]]);_6e3‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_6e3‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
  ...
  try {
    ...
    await user.save();
    _6e3‍.g.console.log("User Created", user);
    return res.json({ ok: true });
  } catch (err) {
    _6e3‍.g.console.log(err);
