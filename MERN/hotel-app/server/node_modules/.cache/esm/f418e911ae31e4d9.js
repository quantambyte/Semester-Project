let User,jwt;_ae3‍.x([["signUp",()=>signUp],["login",()=>login]]);_ae3‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_ae3‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
    ...
    try{
        ...
        await user.save()
        _ae3‍.g.console.log('User Created' , user);
        return res.json( { ok : true } )

    }catch (err){
        _ae3‍.g.console.log(err);
    ...
    try{
        ...
        user.comparePassword ( password , ( err , match ) => {
            ...
            let token = jwt.sign({_id : user._id} , process.env.JWT_SECRET , { expiresIn: '320'} )

            // generate a jwt
            _ae3‍.g.console.log('Token Generated' , token)
